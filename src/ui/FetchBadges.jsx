...
/** @param {{ p: object; fetchedMeta?: object|null; badgePrefix?: string; compact?: boolean }} props */
export default function FetchBadges({ p, fetchedMeta, badgePrefix = "ff-b", compact = false }) {
  const bp = badgePrefix;
  const oa = oaStatusBadge(p.oa, fetchedMeta, bp);
