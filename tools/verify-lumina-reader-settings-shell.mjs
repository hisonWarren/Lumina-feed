...
ok(has(st, "const [rememberPos, setRememberPos]") && has(st, "const [defaultZoom") && has(st, "const [nightInvert") && has(st, "saveReader"), "「阅读」分类：续读/默认缩放/夜读 + 保存");
...
ok(has(ff, "ff-src-label") && has(ff, "命中来源"), "来源条加「命中来源」标签（不再裸贴左）");
