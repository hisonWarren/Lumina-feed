...
ok(/typeof bridge\.subsList === "function"/.test(app), "订阅计数走 bridge.subsList（缺失静默）");
...
ok(/import \{ DEFAULT_THEME, THEME_CSS, isLight, THEMES \}/.test(app) && /Palette, Check/.test(app), "导入：THEMES/Palette/Check/LOGO_DATA_URI");
