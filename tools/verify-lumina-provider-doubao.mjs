...
ok(/doubao:\s*\[[^\]]*vision[^\]]*\]/.test(st) || /CURATED_MODELS\.doubao/.test(st), "MODEL_PRESETS.doubao 含视觉模型（doubao-*-vision-*）");
ok(/doubao:\s*\[[^\]]*doubao-seed[^\]]*\]/.test(st) || /CURATED_MODELS\.doubao/.test(st), "MODEL_PRESETS.doubao 含多模态 seed 模型");
