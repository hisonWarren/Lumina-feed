...
ok(/paperTitleById/.test(sub) && (sub.match(/paperTitleById=\{paperTitleById\}/g) || []).length >= 1, "Subscriptions 构建 id→标题映射并传给 Reader");
...
ok((hero.match(/<ReportSections\b/g) || []).length >= 1 && /className="dg-rp-link"/.test(hero), "Reader 用 ReportSections 提供主题跳转链接（扫描 Hero 仅展示 brief）");
